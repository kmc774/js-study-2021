...
<body>
	...
	<section>
		<div class="board_section">
			<h2> 게시글을 작성해주세요.</h2>
			<div class="board_section">
				<form action="/board/writesave" method="get" class="board_form" id="board_form" name="board_form">
					<label>제목</label>
					<input type="text" class="title"  name ="title" id="title" oninput="maxlength(this)" required="required">
					
					<label>내용</label>
					<textarea rows="20" cols="50" placeholder="내용을 입력하세요." class="val" id="val" name="val" required="required"></textarea>	
