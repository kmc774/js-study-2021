    ...
    <div class="board_form" >
        ...
        <div class="userId_section">
            ...
            <c:forEach var="file" items="${files}">
                <a class="btn_del-file" name="${file.fileIdx} "id="${file.fileIdx}" onclick="deleteFile('${file.fileIdx}')">${file.originFileName}</a>
...
<script>
    ...
    function modifyBoard(){
        ...
        if (confirm('게시글을 수정하시겠습니까 ?')) {
            ...
            const paramObj = { 'title'  : title
                             , 'content': content
                             , 'bdIdx'  : bdIdx
                             , 'files'  : files}; // 오브젝트 객체로 보내기
            $.ajax({
            type:"PUT",
            url:url,
