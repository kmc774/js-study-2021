    ...
    <div class="board_form" >
        ...
        <div class="btn_section">
            <button type="button" class="search_btn"
                    onclick="location.href='/board/goUpdate?bdIdx=${board.bdIdx}&page=${paging.page}&cntPerPage=${paging.cntPerPage}&type=${paging.type}&keyword=${paging.keyword}&filter=${paging.filter}'">수정하기</button>
