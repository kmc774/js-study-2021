			...
			<div class="board_section">
				<div class="board_form" >
					...
					<div class="btn_section"> 
						<button type="button" onclick="location.href='/board/modify?bdIdx=${board.bdIdx}'">수정하기</button>
						<button type="button" onclick="deleteBd()">삭제하기</button>
						<button type="button" onclick="location.href='/board/view/list'">목록보기</button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function deleteBd(){
		if(window.confirm("게시글을 삭제하시겠습니까 ?") == true){
			location.href = "/board/view/delete?bdIdx=" + ${board.bdIdx};
		}else{
			return;
		}
	}
