...
<body>
	...
	<section>
		<div class="board_section">
			<h3>게시글 수정</h3>
			<div class="board_section">
				<form:form modelAttribute="board" action="/board/modifySave" method="GET" class="board_form" id="board_form" name="board_form" >
	...
	function modify(){
	 ...
	 function back(){
		...
		if(window.confirm("게시글 수정을 취소하시겠습니까 ?") == true){
			location.href = "/board/view/detail?bdIdx=" + ${board.bdIdx};
		}else{
			return;
		}
	 }
